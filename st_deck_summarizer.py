...
def main():
    ...
    if env_api_key is not None:
        ...
        api_key_input = api_key_holder.text_input("OpenAI API Key. :gray[*Read more [here](https://help.openai.com/en/articles/4936850-where-do-i-find-my-api-key)*]", type="password", value=st.session_state['api_key'])
